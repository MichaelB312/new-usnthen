...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md z-50 border-b border-purple-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-patrick text-2xl gradient-text">Us & Then</span>
          </Link>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden px-6 pt-32 pb-24 sm:py-40">
        <motion.div 
        ...
        >
          <motion.div 
            className="mb-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-100 to-pink-100 px-4 py-2"
            whileHover={{ scale: 1.05 }}
          >
            <Sparkles className="h-5 w-5 text-purple-600" />
            <span className="text-sm font-medium text-purple-700">AI-Powered Story Magic ✨</span>
          </motion.div>
          
          <h1 className="font-patrick text-7xl sm:text-8xl lg:text-9xl gradient-text mb-6 leading-tight">
            Us & Then
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <motion.button
              ...
              className="btn-primary text-xl px-10 py-5 flex items-center justify-center gap-3 shadow-2xl"
            >
            ...
            <motion.button
              ...
              className="btn-secondary text-xl px-10 py-5 flex items-center justify-center gap-3"
            >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          >
            <Baby className="h-14 w-14 text-purple-400" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 bg-white/50">
        <div className="mx-auto max-w-7xl">
          ...
          >
            <h2 className="text-5xl font-patrick mb-4 gradient-text">
              How It Works
            </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={`mb-6 inline-flex p-4 rounded-2xl bg-gradient-to-br ${feature.gradient} text-white shadow-lg`}>
                      <Icon className="h-8 w-8" />
                    </div>
                    <h3 className="text-2xl font-semibold mb-3 text-gray-800">{feature.title}</h3>
                    <p className="text-gray-600 leading-relaxed">{feature.description}</p>
                    <div className="mt-4 flex items-center text-purple-600 font-medium">
                      <span className="text-4xl font-patrick mr-3">{index + 1}</span>
                      <ChevronRight className={`h-5 w-5 transform transition-transform ${hoveredFeature === index ? 'translate-x-2' : ''}`} />
                    </div>
                  </div>
                </motion.div>
              );
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-purple-100 px-6 py-12">
        <div className="max-w-7xl mx-auto text-center text-gray-600">
          <p className="mb-4">© 2024 Us & Then. Made with 💜 for parents everywhere.</p>
        </div>
      </footer>
    </div>
  );
