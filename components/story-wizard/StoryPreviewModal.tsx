...
export function StoryPreviewModal({
  ...
  const [feedback, setFeedback] = useState<string[]>(
    new Array(previewData.pages.length).fill('')
  );

  if (!isOpen) return null;

  const currentPage = previewData.pages[currentPageIndex];
  const totalPages = previewData.pages.length;
  ...
  const hasFeedback = feedback.some(f => f.trim().length > 0);
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {/* Story draft + Illustration plan - Combined view */}
                  <div className="grid md:grid-cols-2 gap-4">
                    {/* Left: Story Draft */}
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-5 border border-purple-100">
                      <div className="flex items-start gap-2 mb-2">
                        <span className="text-lg">📝</span>
                        <h3 className="font-semibold text-purple-900">Story Draft:</h3>
                      </div>
                      <p className="text-gray-700 italic leading-relaxed pl-7 text-sm">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-5 border border-blue-100">
                      ...
                      <p className="text-gray-700 leading-relaxed pl-7 text-sm">
            ...
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              ...
              <div className="mt-4 text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Once you approve, we'll write the final poetic story and create the beautiful illustrations!
                </p>
              </div>
            </div>
          </motion.div>
